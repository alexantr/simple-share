;(function ($) {
    ...
    var css = '.simple-share, .simple-share * { line-height: normal; }\n' +
        '.simple-share a { display: inline-block; font-size: 1.4rem; text-decoration: none; margin: 0 0.2em 0 0; padding: 0.4em; border: none; border-radius: 4px; vertical-align: top; color: #fff; transition: all .2s; }\n' +
